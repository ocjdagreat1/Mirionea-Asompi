...
<motion.div
className="absolute inset-0 rounded-full bg-yellow-300/25 blur-2xl"
animate={{
scale:[1,1.4,1],
opacity:[.3,.7,.3]
}}
...
<motion.p
  ...
  "
>
  Create your account to begin your journey toward becoming the
...
>
  <div className="px-4 py-2 rounded-full bg-yellow-400/10 border border-yellow-400/20 text-yellow-300 text-sm tracking-wide">
    🚀 Join • Play • Become a Millionaire
  </div>
</motion.div>
...
<UserIcon className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-yellow-400"/>
...
required
className="w-full pl-12 py-4 pr-4 rounded-xl bg-slate-800/60 backdrop-blur-md border border-slate-700 text-white placeholder:text-gray-500 focus:outline-none focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 transition-all"
/>
...
whileHover={{
scale:1.03,
boxShadow:"0 0 35px rgba(250,204,21,.45)"
}}
whileTap={{
scale:.97
}}
